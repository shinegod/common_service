...
public final class SaeContextWrapper {
    ...
    /**
    static {
        SAE_SPECIAL_CONFIG.put("domains.www", "c.hadwins.com");
        SAE_SPECIAL_CONFIG.put("domains.job", "job.c.hadwins.com");
        SAE_SPECIAL_CONFIG.put("domains.sae", "guide.c.hadwins.com");
        SAE_SPECIAL_CONFIG.put("domains.club", "company.c.hadwins.com");

        for (String value : SAE_SPECIAL_CONFIG.values()) {
            SAE_SPECIAL_DOMAIN.put(value, 0); //key只用来判断域名是否匹配，value没有实质性作用
        }

        SAE_TEMPLATE_REPLACE.put("www.hadwins.com", "c.hadwins.com");
        SAE_TEMPLATE_REPLACE.put("job.hadwins.com", "job.c.hadwins.com");
        SAE_TEMPLATE_REPLACE.put("company.hadwins.com", "company.c.hadwins.com");
    }
    */
