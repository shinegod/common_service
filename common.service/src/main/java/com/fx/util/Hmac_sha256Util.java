 ...
 *
 */
@Service("hwDigestService")
public class Hmac_sha256Util {
	
	private static final Logger logger = LoggerFactory.getLogger(Hmac_sha256Util.class);
	 ...
	 * @param data 参与验证的参数
     * @param privateKey 参与验证的accessKey
