 ...
 * 
 */
public class SqlSessionWrapperGlobal implements ISqlSessionWrapper{
    private static final Logger LOG = LoggerFactory.getLogger(SqlSessionWrapperGlobal.class);
    
   @Autowired
   @Qualifier("globalSqlSessionFactory")
