 ...
 * 
 */
public class SqlSessionWrapperMt4TradeRecord implements ISqlSessionWrapper{
    private static final Logger LOG = LoggerFactory.getLogger(SqlSessionWrapperMt4TradeRecord.class);
    
   @Autowired
   @Qualifier("mt4TradeRecordSqlSessionFactory")
