...
public class ChangeCharset {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		System.out.println(changeCharset("这是一个字符集测试，作者为Harttle",UTF_8,GBK));
		System.out.println(changeCharset("这是一个字符集测试，作者为Harttle",GBK,UTF_8));
		System.out.println(changeCharset(changeCharset("这是一个字符集测试，作者为Harttle",GBK,UTF_8),UTF_8,GBK));
		ChangeCharset test = new ChangeCharset();
		String str = "这是一个字符集测试，作者为Harttle";
		System.out.println("str:" + str);
		byte[] bs = str.getBytes(UTF_8);
		String gbk = test.toGBK(str);
		System.out.println(bs.toString());
		System.out.println(bs.toString().getBytes(UTF_8));
		System.out.println("转换成GBK码:" + gbk);
		System.out.println();
		
		String ascii = test.toASCII(str);
		System.out.println("转换成US-ASCII:" + changeCharset(gbk,GBK,UTF_8));
		System.out.println();
